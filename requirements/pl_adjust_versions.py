...
VERSIONS = [
    dict(torch="2.9.0", torchvision="0.24.0"),  # nightly
    dict(torch="2.8.0", torchvision="0.23.0"),  # stable
    dict(torch="2.7.1", torchvision="0.22.1"),
    dict(torch="2.7.0", torchvision="0.22.0"),
    dict(torch="2.6.1", torchvision="0.22.1"),
    dict(torch="2.7.0", torchvision="0.22.0"),
